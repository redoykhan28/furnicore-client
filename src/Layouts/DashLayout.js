            ...
            <div className="drawer drawer-mobile">
                ...
                <div className="drawer-side  bg-neutral pt-6">
                    ...
                    <ul className="menu pr-8 w-80 text-base-content">
                        ...
                        <li><NavLink className={({ isActive }) => isActive ? 'bg-gradient-to-r from-secondary to-accent  text-white rounded-sm mt-2 rounded-r-full shadow-xl' : 'text-black  text-decoration-none font-bold'} to={'/addProduct'}><FaPlusCircle /> Add Product</NavLink></li>
